...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="assigned_projects"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/assigned_projects/index'); ?>"><i class="icon_table"></i>Assigned Projects</a></li>
<li <?php if($this->router->fetch_class()=="attendance"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/attendance/index'); ?>"><i class="icon_table"></i>Attendance</a></li>
<li <?php if($this->router->fetch_class()=="leave"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/leave/index'); ?>"><i class="icon_table"></i>Leave</a></li>
<li <?php if($this->router->fetch_class()=="log_tasks"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/log_tasks/index'); ?>"><i class="icon_table"></i>Log Tasks</a></li>
...
<li <?php if($this->router->fetch_class()=="salary"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/salary/index'); ?>"><i class="icon_table"></i>Salary</a></li>
