...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2020 at 02:57 PM
...
CREATE TABLE `assigned_projects` (
  `id` int(10) NOT NULL,
  `employee_users_id` int(10) NOT NULL,
...
CREATE TABLE `attendance` (
  ...
  `time_attendance` varchar(64) NOT NULL,
  `date_departure` date NOT NULL,
  `time_departure` varchar(64) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf16;
